...
require_once('dbconnect.php');
			...
			$team_name =  trim(mysqli_real_escape_string($con,$_POST['prop_upload_name']));
			$team_pass =  trim(mysqli_real_escape_string($con,sha1("$_POST[prop_upload_pass]")));
			$team_flag = 0;
			...
			if(empty($_POST['prop_upload_pass'])==true){
